...
def simulate_tick(cows: List[Cow], grid: List, nb_tour: int, hunger_evolution: int, thirst_evolution: int, milk_evolution: int, add_hunger: int, add_thirst: int, percentage_hunger: int, percentage_thirst: int, algorithm_to_farm: str, csv_filepath: str | None, show_analysis: bool, mix_food_params: dict[str, dict[str, str | int | float]], breeder_salary: float) -> float:
    """
